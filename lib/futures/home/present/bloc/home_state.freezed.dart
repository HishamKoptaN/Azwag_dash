...
class _$OrdersLoadedImpl implements _OrdersLoaded {
  const _$OrdersLoadedImpl({required final List<Order> orders})
      : _orders = orders;
  ...
  @override
  String toString() {
    return 'HomeState.ordersLoaded(orders: $orders)';
  }
...
abstract class _OrdersLoaded implements HomeState {
  const factory _OrdersLoaded({required final List<Order> orders}) =
      _$OrdersLoadedImpl;

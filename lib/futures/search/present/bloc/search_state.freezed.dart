...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<Order> order}) : _order = order;
  ...
  @override
  String toString() {
    return 'SearchState.loaded(order: $order)';
  }
...
abstract class _Loaded implements SearchState {
  const factory _Loaded({required final List<Order> order}) = _$LoadedImpl;

...
class _$RequesterDataImpl implements _RequesterData {
  ...
  @override
  String toString() {
    return 'RequesterData(id: $id, firstName: $firstName, secondName: $secondName, title: $title, mobileNumber: $mobileNumber, weight: $weight, age: $age, tribeName: $tribeName, nationality: $nationality, gender: $gender, skinColor: $skinColor, employmentStatus: $employmentStatus, commitmentDegree: $commitmentDegree, tribe: $tribe, isSmoker: $isSmoker, maritalStatus: $maritalStatus, educationalLevel: $educationalLevel, mariageType: $mariageType, residenceArea: $residenceArea, originRegion: $originRegion, acceptAnotherNationality: $acceptAnotherNationality, selfInformation: $selfInformation, email: $email)';
  }
...
abstract class _RequesterData implements RequesterData {
  const factory _RequesterData(
      ...
      @JsonKey(name: "email") final String? email}) = _$RequesterDataImpl;
